...
var config = require('./config'),
    ...
    app = chat(),
    messages_actions = require('./controllers/messages'),
    sessions_actions = require('./controllers/sessions'),
    settings_actions = require('./controllers/settings'),
    recent_users_actions = require('./controllers/recent_users_action'),
    dialogs_actions= require('./controllers/dialogs'),
    util = require('util'),
