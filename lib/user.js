...
UserCollection.prototype.dialog_key = function (first, second) {
    ...
    if (current === null) {
        throw PublicError("Error delivering message: can't determine current key.")
    }

    if (opposite === null) {
        throw PublicError("Error delivering message: can't determine opposite key.")
    }
...
UserCollection.prototype.deliver_message = function (message, sender_id) {
    ...
    var key = this.dialog_key(sender_id, recipient_id);
...
UserCollection.prototype.delete_messages = function (payload, sender_id) {
    var key = this.dialog_key(payload.contact_id, sender_id);
